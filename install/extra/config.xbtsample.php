...
$INSTALLER09['bot_name'] = 'U232_bot';
$INSTALLER09['bot_role'] = 8;
...
$INSTALLER09['php_error_log'] = ROOT_DIR . 'phperr_log' . DIRECTORY_SEPARATOR . 'php_err_' . date('M_D_Y') . '.log';
ini_set("error_log", "". $INSTALLER09['php_error_log'] .""); 
//== XBT or PHP announce
if (XBT_TRACKER == true) {
...
$INSTALLER09['variant'] = 'Codename Trinity';
