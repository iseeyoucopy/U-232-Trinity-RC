...
sql_query("INSERT INTO coins (userid, torrentid, points) VALUES (" . sqlesc($CURUSER["id"]) . ", " . sqlesc($id) . ", " . sqlesc($points) . ")") || sqlerr(__FILE__, __LINE__);
...
sql_query("INSERT INTO messages (sender, receiver, msg, added, subject) VALUES({$TRINITY20['bot_id']}, " . sqlesc($userid) . ", $msg, " . TIME_NOW . ", $subject)") || sqlerr(__FILE__, __LINE__);
