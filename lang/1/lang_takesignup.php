...
$lang = [
    ...
    'takesignup_dupe' => "Double account signup detected!",
    'takesignup_warn' => "This user tried to create another account.\n A double account.",
    'takesignup_msg_dupe1' => "This user tried to create another account on the site.\n His action has been logged, new email adress has been banned.",
    'takesignup_msg_dupe2' => "tried to create another account on the site.\n His action has been logged, new email adress has been banned.",
    'takesignup_msg_dupe3' => "<strong>Registration not allowed.</strong>\n You can't make another account.\n You have an account at our tracker.\n Your action will be logged. ",
];
