...
$lang = [
    ...
    'invites_send_emailpart1' => "You have been invited to {$TRINITY20['site_name']} by",
...
{$TRINITY20['baseurl']}/useragreement.php\n
 
{$TRINITY20['baseurl']}/rules.php\n
 
{$TRINITY20['baseurl']}/faq.php\n
...
We urge you to read the RULES and FAQ before you start using {$TRINITY20['site_name']}.",
    ///
    'invites_send_email1_ema' => "You have been invited to {$TRINITY20['site_name']}",
    'invites_send_email1_bod' => "From: {$TRINITY20['site_email']}",
    ///
    'invites_send_email2' => "Hey there :wave:
Welcome to {$TRINITY20['site_name']}!\n
We have made many changes to the site, and we hope you enjoy them!\n 
We have been working hard to make {$TRINITY20['site_name']} somethin' special!\n
{$TRINITY20['site_name']} has a strong community (just check out forums), and is a feature rich site.\n
We hope you'll join in on all the fun!\n
Be sure to read the [url={$TRINITY20['baseurl']}/rules.php]Rules[/url] and [url={$TRINITY20['baseurl']}/faq.php]FAQ[/url] before you start using the site.\n
We are a strong friendly community here :D {$TRINITY20['site_name']} is so much more then just torrents.\n
...
{$TRINITY20['site_name']} Staff.\n",
    ///
    'invites_send_email2_sub' => "Welcome to {$TRINITY20['site_name']} !",
];
?>