...
foreach ($countries as $cntry) {
    if (is_array($cntry)) {
        $country .= "<option value='".(int)$cntry['id']."'".($user_country == $cntry['id'] ? " selected='selected'" : "").">".htmlspecialchars($cntry['name'])."</option>\n";
    }
}
...
<div class='grid-container'>
	...
	<div class='callout'>
    <form role='form' method='post' title='signup' action='take_invite_signup.php'>
		...
		<div class='input-group'>
			...
			<input class='input-group-field' type='text' placeholder='{$lang['signup_invcode']}' name='invite'>
		</div>
		<div class='input-group'>
			<span class='input-group-label'>
