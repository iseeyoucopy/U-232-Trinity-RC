...
$pms = [];
if ($pm_what == "last10") {
    ($res = sql_query("SELECT $What_Table.$What_user_id as userid, $What_Table.$What_id FROM $What_Table WHERE $What_Table.$What_id =".sqlesc($reseedid)." AND $What_Table.$What_TF LIMIT 10")) || sqlerr(__FILE__,
        __LINE__);
