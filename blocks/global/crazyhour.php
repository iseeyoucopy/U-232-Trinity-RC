    ...
    function crazyhour()
    {
        ...
        if (($crazyhour['crazyhour'] = $cache->get('crazyhour')) === false) {
            ...
            if ($crazyhour['crazyhour_sql']->num_rows !== 0) {
                $crazyhour['crazyhour'] = $crazyhour['crazyhour_sql']->fetch_assoc();
            } else {
        ...
        <div class="input-group margin-0">
            ...
            <span class="input-group-label label primary">'.$crazytitle.$crazymessage.$lang['gl_crazy_ends'].' '.mkprettytime($crazyhour['remaining']).'&nbsp;'.$lang['gl_crazy_at'].' '.get_date($crazyhour['crazyhour']['var'],
                        'LONG').'</span>
        </div>');
        }
        return $htmlout.('
