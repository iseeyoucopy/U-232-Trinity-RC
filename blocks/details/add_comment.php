<?php
$HTMLOUT .= "<hr /><br /> 
<h2 class='text-center'>{$lang['details_comments']}<a href='details.php?id=$id'>".htmlspecialchars($torrents["name"], ENT_QUOTES)."</a></h2>";
...
<p><a name='startcomments'></a></p>
    ...
    <input type='hidden' name='tid' value='".htmlspecialchars($id)."' /><br />
