...
if ($user['sendpmpos'] != 1) {
    ...
    if ($user['sendpmpos'] == 0) {
        ...
        $HTMLOUT .= "<p class='help-text' id='sendpm_pos'>{$lang['userdetails_until']} ".get_date($user['sendpmpos'],
                'DATE')." (".mkprettytime($user['sendpmpos'] - TIME_NOW)." {$lang['userdetails_togo']})</p>";
    }
