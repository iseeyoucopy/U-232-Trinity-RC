...
if ($user['avatarpos'] != 1) {
  ...
  if ($user['avatarpos'] == 0) {
      ...
      $HTMLOUT.= "<p class='help-text' id='avatar_pos'>{$lang['userdetails_until']} " . get_date($user['avatarpos'], 'DATE') . " (" . mkprettytime($user['avatarpos'] - TIME_NOW) . " {$lang['userdetails_togo']})</p>";
  } 
