...
if ($user['uploadpos'] != 1) {
    ...
    if ($user['uploadpos'] == 0) {
        ...
        $HTMLOUT .= "<p class='help-text' id='upload_pos'>{$lang['userdetails_until']} ".get_date($user['uploadpos'],
                'DATE')." (".mkprettytime($user['uploadpos'] - TIME_NOW)." {$lang['userdetails_togo']})</p>";
    }
