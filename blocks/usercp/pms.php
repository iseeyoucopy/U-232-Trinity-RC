                ...
                <div class='card'>
                    ...
                    <div class='card-section'>
                        <div class='switch large'>
                            <input onchange='this.form.submit()' class='input-group-field switch-input' type='checkbox' id='pmnotif_id'  name='pmnotif' ".(strpos($CURUSER['notifs'],
        "[pm]") !== false ? "checked='checked'" : "")." value='yes'>
