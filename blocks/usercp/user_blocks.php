<?php
//==Index
$checkbox_index_ie_alert = (((curuser::$blocks['index_page'] & block_index::IE_ALERT) !== 0) ? ' checked="checked"' : '');
$checkbox_index_news = (((curuser::$blocks['index_page'] & block_index::NEWS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_shoutbox = (((curuser::$blocks['index_page'] & block_index::SHOUTBOX) !== 0) ? ' checked="checked"' : '');
$checkbox_index_active_users = (((curuser::$blocks['index_page'] & block_index::ACTIVE_USERS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_active_24h_users = (((curuser::$blocks['index_page'] & block_index::LAST_24_ACTIVE_USERS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_active_birthday_users = (((curuser::$blocks['index_page'] & block_index::BIRTHDAY_ACTIVE_USERS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_stats = (((curuser::$blocks['index_page'] & block_index::STATS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_disclaimer = (((curuser::$blocks['index_page'] & block_index::DISCLAIMER) !== 0) ? ' checked="checked"' : '');
$checkbox_index_latest_user = (((curuser::$blocks['index_page'] & block_index::LATEST_USER) !== 0) ? ' checked="checked"' : '');
$checkbox_index_latest_forumposts = (((curuser::$blocks['index_page'] & block_index::FORUMPOSTS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_latest_torrents = (((curuser::$blocks['index_page'] & block_index::LATEST_TORRENTS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_latest_torrents_scroll = (((curuser::$blocks['index_page'] & block_index::LATEST_TORRENTS_SCROLL) !== 0) ? ' checked="checked"' : '');
$checkbox_index_announcement = (((curuser::$blocks['index_page'] & block_index::ANNOUNCEMENT) !== 0) ? ' checked="checked"' : '');
$checkbox_index_donation_progress = (((curuser::$blocks['index_page'] & block_index::DONATION_PROGRESS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_ads = (((curuser::$blocks['index_page'] & block_index::ADVERTISEMENTS) !== 0) ? ' checked="checked"' : '');
$checkbox_index_radio = (((curuser::$blocks['index_page'] & block_index::RADIO) !== 0) ? ' checked="checked"' : '');
$checkbox_index_torrentfreak = (((curuser::$blocks['index_page'] & block_index::TORRENTFREAK) !== 0) ? ' checked="checked"' : '');
$checkbox_index_xmasgift = (((curuser::$blocks['index_page'] & block_index::XMAS_GIFT) !== 0) ? ' checked="checked"' : '');
$checkbox_index_active_poll = (((curuser::$blocks['index_page'] & block_index::ACTIVE_POLL) !== 0) ? ' checked="checked"' : '');
$checkbox_index_staffshoutbox = (((curuser::$blocks['index_page'] & block_index::STAFF_SHOUT) !== 0) ? ' checked="checked"' : '');
$checkbox_index_mow = (((curuser::$blocks['index_page'] & block_index::MOVIEOFWEEK) !== 0) ? ' checked="checked"' : '');
$checkbox_index_reqnoff = (((curuser::$blocks['index_page'] & block_index::REQNOFF) !== 0) ? ' checked="checked"' : '');
//==Stdhead
$checkbox_global_freeleech = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_FREELEECH) !== 0) ? ' checked="checked"' : '');
$checkbox_global_demotion = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_DEMOTION) !== 0) ? ' checked="checked"' : '');
$checkbox_global_message_alert = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_NEWPM) !== 0) ? ' checked="checked"' : '');
$checkbox_global_staff_message_alert = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_STAFF_MESSAGE) !== 0) ? ' checked="checked"' : '');
$checkbox_global_staff_report = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_REPORTS) !== 0) ? ' checked="checked"' : '');
$checkbox_global_staff_uploadapp = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_UPLOADAPP) !== 0) ? ' checked="checked"' : '');
$checkbox_global_happyhour = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_HAPPYHOUR) !== 0) ? ' checked="checked"' : '');
$checkbox_global_crazyhour = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_CRAZYHOUR) !== 0) ? ' checked="checked"' : '');
$checkbox_global_bugmessage = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_BUG_MESSAGE) !== 0) ? ' checked="checked"' : '');
$checkbox_global_freeleech_contribution = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_FREELEECH_CONTRIBUTION) !== 0) ? ' checked="checked"' : '');
$checkbox_global_stafftools = (((curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_STAFFTOOLS) !== 0) ? ' checked="checked"' : '');
//==Userdetails
$checkbox_userdetails_login_link = (((curuser::$blocks['userdetails_page'] & block_userdetails::LOGIN_LINK) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_flush = (((curuser::$blocks['userdetails_page'] & block_userdetails::FLUSH) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_joined = (((curuser::$blocks['userdetails_page'] & block_userdetails::JOINED) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_onlinetime = (((curuser::$blocks['userdetails_page'] & block_userdetails::ONLINETIME) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_browser = (((curuser::$blocks['userdetails_page'] & block_userdetails::BROWSER) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_reputation = (((curuser::$blocks['userdetails_page'] & block_userdetails::REPUTATION) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_userhits = (((curuser::$blocks['userdetails_page'] & block_userdetails::PROFILE_HITS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_birthday = (((curuser::$blocks['userdetails_page'] & block_userdetails::BIRTHDAY) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_contact_info = (((curuser::$blocks['userdetails_page'] & block_userdetails::CONTACT_INFO) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_iphistory = (((curuser::$blocks['userdetails_page'] & block_userdetails::IPHISTORY) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_traffic = (((curuser::$blocks['userdetails_page'] & block_userdetails::TRAFFIC) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_shareratio = (((curuser::$blocks['userdetails_page'] & block_userdetails::SHARE_RATIO) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_seedtime_ratio = (((curuser::$blocks['userdetails_page'] & block_userdetails::SEEDTIME_RATIO) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_seedbonus = (((curuser::$blocks['userdetails_page'] & block_userdetails::SEEDBONUS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_connectable = (((curuser::$blocks['userdetails_page'] & block_userdetails::CONNECTABLE_PORT) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_avatar = (((curuser::$blocks['userdetails_page'] & block_userdetails::AVATAR) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_userclass = (((curuser::$blocks['userdetails_page'] & block_userdetails::USERCLASS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_gender = (((curuser::$blocks['userdetails_page'] & block_userdetails::GENDER) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_freestuffs = (((curuser::$blocks['userdetails_page'] & block_userdetails::FREESTUFFS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_torrent_comments = (((curuser::$blocks['userdetails_page'] & block_userdetails::COMMENTS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_forumposts = (((curuser::$blocks['userdetails_page'] & block_userdetails::FORUMPOSTS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_invitedby = (((curuser::$blocks['userdetails_page'] & block_userdetails::INVITEDBY) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_torrents_block = (((curuser::$blocks['userdetails_page'] & block_userdetails::TORRENTS_BLOCK) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_completed = (((curuser::$blocks['userdetails_page'] & block_userdetails::COMPLETED) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_snatched_staff = (((curuser::$blocks['userdetails_page'] & block_userdetails::SNATCHED_STAFF) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_userinfo = (((curuser::$blocks['userdetails_page'] & block_userdetails::USERINFO) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_showpm = (((curuser::$blocks['userdetails_page'] & block_userdetails::SHOWPM) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_report = (((curuser::$blocks['userdetails_page'] & block_userdetails::REPORT_USER) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_userstatus = (((curuser::$blocks['userdetails_page'] & block_userdetails::USERSTATUS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_usercomments = (((curuser::$blocks['userdetails_page'] & block_userdetails::USERCOMMENTS) !== 0) ? ' checked="checked"' : '');
$checkbox_userdetails_showfriends = (((curuser::$blocks['userdetails_page'] & block_userdetails::SHOWFRIENDS) !== 0) ? ' checked="checked"' : '');
//**Browse Page */
$HTMLOUT .= '
