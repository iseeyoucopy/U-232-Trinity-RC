    ...
    if (count($result) == 0) {
        ...
        <table width="55%" style="border-collapse:collapse;" border="1" cellspacing="0" cellpadding="5">
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                ?>
                <tr>
                    <td align="center" nowrap="nowrap"><img src="flag/<?php echo($movie["iso639"]) ?>.gif" width="18" height="12" border="0"
                                                            alt="<?php echo($movie["language"]) ?>" title="<?php echo($movie["language"]) ?>"/></td>
                    ...
                    <td nowrap="nowrap" align="center"><a href="<?php echo($base.$movie["download"]) ?>" target="blank"><img
                                    src="imgs/icon-download.gif" width="12" height="12" border="0" alt=" " title="download"/></a></td>
