...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-open-details]').click(function (e) {
  e.preventDefault();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next().toggleClass('is-active');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    ...
    success: function success(data) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#unread_m').append(data);
    }
  });
  setInterval(function () {
    //setInterval() method execute on every interval until called clearInterval()
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#unread_m').load('ajax.php').fadeIn('slow'); //load() method fetch data from fetch.php page
  }, 1000);
});
})();
