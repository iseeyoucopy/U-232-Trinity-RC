...
{$posticon}&nbsp;
    ...
    if (is_valid_id($arr['edited_by'])) {
        $HTMLOUT .= "<span class='post_edit' id='edited_by_14'><font size='1' class='small'>Last edited by <a href='{$TRINITY20['baseurl']}/userdetails.php?id=" . (int) $arr['edited_by'] . "'><strong>" . htmlsafechars($arr['u2_username']) . "</strong></a> at " . get_date($arr['edit_date'], 'LONG', 1, 0) . " GMT</font></span>";
    }
    $HTMLOUT .= "</span>
    </div>";
    if (isset($newp)) {
