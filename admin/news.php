...
//==Final Actions
if ($mode == 'news') {
    ($res = sql_query("SELECT n.id AS newsid, n.body, n.title, n.userid, n.added, n.anonymous, u.id, u.username, u.class, u.warned, u.chatpost, u.pirate, u.king, u.leechwarn, u.enabled, u.donor FROM news AS n LEFT JOIN users AS u ON u.id=n.userid ORDER BY sticky, added DESC")) || sqlerr(__FILE__,
        __LINE__);
