...
($res = sql_query("SELECT uh.*, username, users.id as uid FROM userhits uh LEFT JOIN users ON uh.userid = users.id WHERE hitid =" . sqlesc($id) . " ORDER BY uh.id DESC " . $pager['limit'])) || sqlerr(__FILE__, __LINE__);
