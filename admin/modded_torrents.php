...
function do_sort($arr, $empty = false)
{
    ...
    if ($empty) {
        ...
        while ($res = $arr->fetch_assoc()) {
            $ret_html .= "<tr><td align='center'><a href='details.php?id=".(int)$res['id']."'>".htmlsafechars($res['name'])."</a></td><td align='center'>".date('h:i:s d/m/Y',
    ...
    if ($count == 1) {
        ...
        $ret_html .= "<tr><td align='center'><a href='details.php?id=".(int)$res['id']."'>".htmlsafechars($res['name'])."</a></td><td align='center'><a href='userdetails.php?id=".(int)$res['uid']."'><font color='#".get_user_class_color($CURUSER['class'])."'>".htmlsafechars($res['checked_by'])."</font></a></td><td align='center'>".date('h:i:s d/m/Y',
    ...
    if ($count > 1) {
        while ($res = $arr->fetch_assoc()) {
            $users[$res['checked_by']] = ((isset($users[$res['checked_by']]) && $users[$res['checked_by']] > 0) ? $users[$res['checked_by']] + 1 : 1);
            $ret_html .= "<tr><td align='center'><a href='details.php?id=".(int)$res['id']."'>".htmlsafechars($res['name'])."</a></td><td align='center'><a href='userdetails.php?id=".(int)$res['uid']."'>".htmlsafechars($res['checked_by'])."</a></td><td align='center'>".date('h:i:s d/m/Y',
                    $res['checked_when'])."</td></tr>";
        }
        return [
            $users,
