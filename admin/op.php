...
<div style="text-align:center;margin-bottom:2em;">
    <p>
        ...
        <a href="staffpanel.php?tool=op&page=reset" class="button" onclick="return confirm('Are you sure you want to reset the cache?');">Reset
            cache</a>
    </p>
</div>
...
<?php if ($page == 'overview'): ?>
    ...
    <div class="container">
        <div id="counts">
            ...
            <div>
                <p><span class="large"><span class="realtime" data-value="hit_rate"><?php echo $data['hit_rate_percentage']; ?></span>%</span><br/>hit
                    rate</p>
            </div>
            <div class="values">
                ...
                <p><b>wasted memory:</b> <span class="realtime" data-value="wasted_memory_size"><?php echo $data['wasted_memory_size']; ?></span>
                    (<span class="realtime" data-value="wasted_percentage"><?php echo $data['wasted_percentage']; ?></span>%)</p>
                ...
                <p><b>number of cached keys:</b> <span class="realtime"
                                                       data-value="num_cached_keys_size"><?php echo $data['num_cached_keys_size']; ?></span></p>
                <p><b>max cached keys:</b> <span class="realtime"
                                                 data-value="max_cached_keys_size"><?php echo $data['max_cached_keys_size']; ?></span></p>
            </div>
            <br/>
        ...
        <div id="info">
            ...
            <table>
                ...
                foreach ($opcache_config['directives'] as $d => $v): ?>
                    <tr class="<?php rc(); ?>">
                        <td><span title="<?php echo $d; ?>"><?php echo str_replace(['opcache.', '_'], ['', ' '], $d); ?></span></td>
...
<?php if ($page == 'files'): ?>
    ...
    <div class="container">
        <h3><?php echo $data['files_cached']; ?> file<?php echo($data['files_cached'] == 1 ? '' : 's'); ?> cached <span id="filterShowing"></span>
        </h3>
        <table>
            <tr>
                <th>Script</th>
