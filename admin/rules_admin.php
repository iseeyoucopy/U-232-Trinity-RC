...
<table class='table table-bordered table-striped'>
    ...
    while ($arr = $sql->fetch_assoc()) {
        $htmlout .= "
            <tr>
            <td>" . intval($arr['id']) . "</td>
            <td><a href='{$TRINITY20['baseurl']}/staffpanel.php?tool=rules_admin&amp;mode=rules_edit&amp;catid=" . intval($arr['id']) . "'>" . htmlsafechars($arr['name']) . "</a></td>
            <td>" . htmlsafechars($arr['shortcut']) . "</td>
            <td>" . htmlsafechars($arr['min_view']) . "</td>
            <td><a href='{$TRINITY20['baseurl']}/staffpanel.php?tool=rules_admin&amp;mode=cat_edit&amp;catid=" . intval($arr['id']) . "'><img src='{$TRINITY20['pic_base_url']}button_edit2.gif' height='15px' width='14px' alt='{$lang['rules_edit']}' style='padding-right:3px' /></a>
            <a href='{$TRINITY20['baseurl']}/staffpanel.php?tool=rules_admin&amp;mode=cat_delete&amp;catid=" . intval($arr['id']) . "'><img src='{$TRINITY20['pic_base_url']}button_delete2.gif' height='13px' width='13px' alt='{$lang['rules_delete']}' style='padding-left:3px' /></a></td>
            </tr>";
    }
