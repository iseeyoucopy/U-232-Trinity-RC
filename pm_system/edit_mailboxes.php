...
if (isset($_POST['action2'])) {
    ...
    case 'edit_boxes':
        ...
        if ($res->num_row() === 0) stderr($lang['pm_error'], $lang['pm_edmail_err1']);
...
<div class="dropdown-pane" id="info-message-box" data-dropdown data-hover="true" data-hover-pane="true">
  ' . $lang['pm_edmail_as_a'] . '' . get_user_class_name($CURUSER['class']) . $lang['pm_edmail_you_may'] . $maxboxes . $lang['pm_edmail_pm_box'] . ($maxboxes !== 1 ? $lang['pm_edmail_pm_boxes'] : '') . '' . $lang['pm_edmail_other'] . '<br />' . $lang['pm_edmail_currently'] . '' . $res->num_row() . $lang['pm_edmail_custom'] . ($res->num_row() !== 1 ? $lang['pm_edmail_custom_es'] : '') . $lang['pm_edmail_may_add'] . ($maxboxes - $res->num_row()) . ''. $lang['pm_edmail_more_extra'] . '<br /><br />
