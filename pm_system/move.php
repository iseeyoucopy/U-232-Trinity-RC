...
if ($mysqli->affected_rows === 0) stderr($lang['pm_error'], '' . $lang['pm_move_err'] . '<a class="altlink" href="pm_system.php?action=view_message&id=' . $pm_id . '>' . $lang['pm_move_back'] . '</a>' . $lang['pm_move_msg'] . '');
