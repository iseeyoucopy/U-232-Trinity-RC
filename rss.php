...
$HTMLOUT = "<?xml version=\"1.0\" encoding=\"windows-1251\" ?>\n<rss version=\"0.91\">\n<channel>\n" . "<title>" . $TRINITY20['site_name'] . "</title>\n<link>" . $TRINITY20['baseurl'] . "</link>\n<description>" . $TRINITY20['rssdescr'] . "</description>\n" . "<language>en-usde</language>\n<copyright>Copyright � " . date('Y') . " " $TRINITY2009['site_name'] . "</copyright>\n<webMaster>" $TRINITY2009['site_email'] . "</webMaster>\n" . "<image><title>" $TRINITY2009['site_name'] . "</title>\n<url>" $TRINITY2009['baseurl'] . "/favicon.ico</url>\n<link>" $TRINITY2009['baseurl'] . "</link>\n" . "<width>16</width>\n<height>16</height>\n<description>" $TRINITY2009['rssdescr'] . "</description>\n</image>\n";
