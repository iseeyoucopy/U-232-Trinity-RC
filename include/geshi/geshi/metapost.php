...
$language_data = [
    ...
    'KEYWORDS' => [
        ...
        5 => [ //operations return path or picture or pen
            'bbox',
            'center',
            'cutafter',
            'cutbefore',
        ...
        6 => [ //operations return string (or complementary)
            'closefrom',
            'fontpart',
            'readfrom',
            'str',
        ...
        9 => [ //operations return color
            'colorpart',
        ],
        10 => [ //operations return transform
            'inverse',
        ],
        11 => [ //constructors
            'also',
        ...
        17 => [ //Internal variables with numeric values
            'ahangle',
            'ahlength',
            'bboxmargin',
            'charcode',
        ...
        18 => [ //Internal string variables
            'filenametemplate',
            'jobname',
            'outputformat',
            'outputtemplate',
        ],
        19 => [ //other predefined variables
            'background',
            'currentpen',
            'currentpicture',
            'cuttings',
