...
function docleanup($data)
{
    ...
    ($res = sql_query("SELECT users.id, users.numuploads, usersachiev.ul FROM users LEFT JOIN usersachiev ON users.id = usersachiev.id WHERE enabled = 'yes' AND numuploads >= '1'")) || sqlerr(__FILE__, __LINE__);
