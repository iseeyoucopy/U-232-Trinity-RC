...
function docleanup($data)
{
    ...
    if ($res->num_rows > 0) {
        ...
        if ($count > 0) {
            ...
            sql_query("INSERT INTO usersachiev (id, sheepach, achpoints) VALUES " . implode(', ', $usersachiev_buffer) . " ON DUPLICATE key UPDATE sheepach=values(sheepach), achpoints=achpoints+values(achpoints)") || sqlerr(__FILE__, __LINE__);
