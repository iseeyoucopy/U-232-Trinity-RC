...
function docleanup($data)
{
    ...
    ($res = sql_query("SELECT users.id, users.seedbonus, usersachiev.bonus FROM users LEFT JOIN usersachiev ON users.id = usersachiev.id WHERE enabled = 'yes' AND users.seedbonus >= '1' AND usersachiev.bonus >= '0'")) || sqlerr(__FILE__, __LINE__);
