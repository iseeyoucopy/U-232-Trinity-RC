...
function docleanup($data)
{
    ...
    if ($res->num_rows > 0) {
        ...
        if ($count > 0) {
            ...
            sql_query("INSERT INTO users (id, uploadpos, modcomment) VALUES " . implode(', ', $users_buffer) . " ON DUPLICATE key UPDATE uploadpos=values(uploadpos), modcomment=values(modcomment)") || sqlerr(__FILE__, __LINE__);
