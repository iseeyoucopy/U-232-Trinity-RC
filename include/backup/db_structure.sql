...
CREATE TABLE `achievements` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `userid` (`userid`)
) ENGINE=MyISAM AUTO_INCREMENT=4471 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ajax_chat_messages` (
  ...
  KEY `dateTime` (`dateTime`)
) ENGINE=MyISAM AUTO_INCREMENT=1807 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bonuslog` (
  ...
  KEY `type` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=2182 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='log of contributors towards freeleech etc...';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cleanup_log` (
  ...
  PRIMARY KEY (`clog_id`)
) ENGINE=MyISAM AUTO_INCREMENT=35558 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comments` (
  ...
  `edit_name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=7364 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts` (
  ...
  `post_history` mediumtext COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `read_posts` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7072 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `referrers` (
  ...
  `date` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2421 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shoutbox` (
  ...
  PRIMARY KEY (`id`),
  KEY `for` (`to_user`)
) ENGINE=MyISAM AUTO_INCREMENT=106806 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sitelog` (
  ...
  PRIMARY KEY (`id`),
  KEY `added` (`added`)
) ENGINE=MyISAM AUTO_INCREMENT=239828 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_blocks` (
  ...
  `browse_page` int(10) unsigned NOT NULL DEFAULT 1024,
  `new_page` int(10) unsigned NOT NULL DEFAULT 4,
...
CREATE TABLE `userhits` (
  ...
  KEY `added` (`added`),
  KEY `hitid` (`hitid`)
) ENGINE=MyISAM AUTO_INCREMENT=2569 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `passhash` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `loginhash` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
  `secret` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `passkey` varchar(64) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `editsecret` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `hash1` text CHARACTER SET utf8 DEFAULT NULL,
  ...
  `torrent_pass` varchar(64) CHARACTER SET utf8 DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=2265 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-27 19:29:01
