...
foreach ($items as $item) {
    $html .= "<div class='col-md-12' style='padding:5px;'><h2 class='text-center'>".$item->getElementsByTagName('title')->item(0)->nodeValue."</h2><hr/>".preg_replace("/<p>Source\:(.*?)width=\"1\"\/>/is",
            "", $item->getElementsByTagName('encoded')->item(0)->nodeValue)."<hr/></div>";
